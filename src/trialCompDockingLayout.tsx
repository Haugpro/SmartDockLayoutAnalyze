...
class TrialCompDockingLayout extends React.Component {
   layout = [{
      id: 'item0',
      label: 'View',
      items: [{
   ...
   render() {
      return (
         <DockingLayout layout={this.layout} onReady={this.handleReady.bind(this)}/>
      );
   }
}

export default TrialCompDockingLayout;
